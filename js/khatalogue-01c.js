...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Khatalogue - 01c", width : 640, height : 240},Main.init);
};
Main.init = function() {
...
Main.render = function(framebuffer) {
	...
	while(_g1 < _g) {
		...
		g1.setPixel(i,120 + (Main.amplitude * dy | 0),kha__$Color_Color_$Impl_$.White);
	}
	g1.end();
};
Math.__name__ = true;
...
kha_CompilerDefines.script_name = "khatalogue-01c";
...
kha_CompilerDefines.canvas_id = "khatalogue-01c";

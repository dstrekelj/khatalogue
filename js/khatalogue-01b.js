...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Khatalogue - 01b", width : 640, height : 240},Main.init);
};
Main.init = function() {
...
Main.render = function(framebuffer) {
	...
	g1.begin();
	var _g1 = 0;
	var _g = framebuffer.get_width() * framebuffer.get_height();
	while(_g1 < _g) {
		++_g1;
		g1.setPixel(Main.random.GetUpTo(framebuffer.get_width() - 1),Main.random.GetUpTo(framebuffer.get_height() - 1),kha__$Color_Color_$Impl_$.White);
	}
	g1.end();
};
Math.__name__ = true;
...
kha_CompilerDefines.script_name = "khatalogue-01b";
...
kha_CompilerDefines.canvas_id = "khatalogue-01b";

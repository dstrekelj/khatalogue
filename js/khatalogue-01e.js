...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Khatalogue - 01e", width : 640, height : 240},Main.init);
};
Main.init = function() {
	kha_System.notifyOnRender(Main.render);
	kha_Scheduler.addTimeTask(Main.update,0,0.016666666666666666);
	kha_Scheduler.addTimeTask(Main.randomize,0,2);
};
Main.randomize = function() {
	Main.amplitude = Main.random.GetIn(10,100);
	Main.period = Main.random.GetIn(10,100);
	Main.color = kha__$Color_Color_$Impl_$.fromFloats(Main.random.GetFloatIn(0.3,1.0),Main.random.GetFloatIn(0.3,1.0),Main.random.GetFloatIn(0.3,1.0));
};
Main.update = function() {
};
Main.render = function(framebuffer) {
	var g1 = framebuffer.get_g1();
	g1.begin();
	var _g1 = 0;
	var _g = framebuffer.get_width();
	while(_g1 < _g) {
		var i = _g1++;
		var dy = Math.sin(kha_Scheduler.time() + i / Main.period);
		Main.color = (Math.abs(dy) * 255 | 0) << 24 | (((Main.color & 16711680) >>> 16) * 0.00392156862745098 * 255 | 0) << 16 | (((Main.color & 65280) >>> 8) * 0.00392156862745098 * 255 | 0) << 8 | ((Main.color & 255) * 0.00392156862745098 * 255 | 0);
		g1.setPixel(i,120 + (Main.amplitude * dy | 0),Main.color);
	}
	g1.end();
};
Math.__name__ = true;
...
Main.MAX_AMPLITUDE = 100;
Main.MIN_AMPLITUDE = 10;
Main.MAX_COLOR_CHANNEL_VALUE = 1.0;
Main.MIN_COLOR_CHANNEL_VALUE = 0.3;
Main.MAX_PERIOD = 100;
Main.MIN_PERIOD = 10;
Main.TASK_PERIOD = 2;
Main.random = new kha_math_Random(0);
Main.amplitude = 100;
Main.period = 100;
Main.color = kha__$Color_Color_$Impl_$.White;
...
kha_CompilerDefines.script_name = "khatalogue-01e";
...
kha_CompilerDefines.canvas_id = "khatalogue-01e";
kha_CompilerDefines["source-header"] = "Generated by Haxe 3.3.0";
kha_CompilerDefines.sys_a2 = "1";
kha_CompilerDefines.js = "1";
kha_CompilerDefines.kha = "1";
kha_CompilerDefines.sys_a1 = "1";
kha_CompilerDefines.haxe_ver = "3.3";

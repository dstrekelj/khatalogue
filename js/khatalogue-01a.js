...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Khatalogue - 01a", width : 640, height : 240},Main.init);
};
Main.init = function() {
...
Main.render = function(framebuffer) {
	...
	g1.begin();
	g1.setPixel(320,120,kha__$Color_Color_$Impl_$.White);
	g1.end();
};
Math.__name__ = true;
...
kha_CompilerDefines.script_name = "khatalogue-01a";
...
kha_CompilerDefines.canvas_id = "khatalogue-01a";
